...
export default function Navbar() {
  ...
  return (
    <header className="bg-white ">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div
          className={
            contentVisible
              ? "block  md:hidden lg:hidden absolute z-1 bg-gray-100 mt-[150px] w-[80vw] rounded"
              : " hidden  md:hidden lg:hidden absolute z-1 bg-gray-100 mt-[150px] w-[80vw] rounded"
          }
        >
          <div className=" bg-teal-600 rounded duration ">
            <ul className="space-y-3 p-5 text-white text-bold">
              <li>
              ...
              <li>
                <Link className="hover:text-gray-500" to="/signup">
                  SignUp
                </Link>
              </li>
            </ul>
